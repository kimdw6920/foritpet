...
urlpatterns = [
    ...
    path('<int:pk>/chat/', views.shelter_chat, name='shelter_chat'),
    path('<int:pk>/chat/messages/', views.shelter_chat_messages, name='shelter_chat_messages'),
    path('<int:pk>/chat/send/', views.shelter_chat_send, name='shelter_chat_send'),
